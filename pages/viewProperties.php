            ...
            <div class="row vh90 padding-top-100 text-center align-cotent-center justify-content-center margin-gap-sidebar">
                <div class="col-md-12">                  
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <h1 class="h1-responsive font-weight-bold text-center my-4 form-padding-50">View Properties</h1>
                                        ...
                                        foreach ($Properties as $property) {
                                            ...
                                            echo '
                                                <tr>
                                                    ...
                                                    <td>'.$pCounty.'</td>
                                                    <td>'.$pBedrooms.'</td>
                                                    <td><a href="viewProperty.php?propertyToView='.$pID.'" class="btn-admin-nav btn-block form-send-opacity font-weight-bold text-center text-decoration-none">View/Edit Property</a></td>
                                                    <td><a href="../php/deleteProperty.php?propertyToDelete='.$pID.'" class="btn-admin-nav btn-block form-send-opacity font-weight-bold text-center text-decoration-none">Remove Property</a></td>
                                                </tr>
                                            ';
                                        };
                                    ?>                                    
